...
Link to Repo - Github - https://github.com/stemesghen/telematics-integration-auto-insurance-project.git

Link to Video - Google Drive - https://drive.google.com/file/d/1owN8X3Qxm7SZD1ZpA8b-_vHVs1J7COmy/view?usp=sharing 
	- My apologies, my Safari is not able to open the video (Link to Assessment is not available to open on another browser. 
